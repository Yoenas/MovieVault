...
abstract class _Tv implements Tv {
  factory _Tv(
      ...
      @JsonKey(name: 'genre_ids') final List<int> genreIds}) = _$TvImpl;
...
/// @nodoc
mixin _$TvList {
  List<Tv> get results => throw _privateConstructorUsedError;
...
class _$TvListImpl implements _TvList {
  _$TvListImpl({required final List<Tv> results}) : _results = results;
...
abstract class _TvList implements TvList {
  factory _TvList({required final List<Tv> results}) = _$TvListImpl;
